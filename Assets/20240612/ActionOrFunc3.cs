...
public class ActionOrFunc3 : MonoBehaviour
{
    ...
    string Func_Call1(int a, float b)
    {
        return "Func1";
    }
    
    string Func_Call2(int a, float b)
    {
        return "Func2";
    }
    
    string Func_Call3(int a, float b)
    {
        return "Func3";
    }
    
    string Func_Call4(int a, float b)
    {
        return "Func4";
    }
    
    string Func_Call5(int a, float b)
    {
        return "Func5";
    }
